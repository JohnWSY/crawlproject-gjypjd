...
def main():
    ...
    for i in range(1, 348):  # 遍历347个一级目录网页
        try:
            browser = webdriver.Chrome(chrome_options=option)
            url_1 = 'http://app1.sfda.gov.cn/datasearchcnda/face3/search.jsp?tableId=60&State=1&bcId=152911821636644848557900526892&State=1&curstart='+str(i)+'&State=1&tableName=TABLE60&State=1&viewtitleName=COLUMN649&State=1&viewsubTitleName=COLUMN643,COLUMN650,COLUMN644&State=1&tableView=%25E8%25BF%259B%25E5%258F%25A3%25E8%258D%25AF%25E5%2593%2581%25E5%2595%2586%25E5%2593%2581%25E5%2590%258D&State=1&cid=0&State=1&ytableId=0&State=1&searchType=search&State=1'
            browser.get(url_1)
            s = browser.page_source.replace('amp;', '')
            m = re.findall(r'content.jsp\?tableId=60&tableName=TABLE60&tableView=进口药品商品名&Id=\d+', s, re.M)
            browser.close()
            ...
            for j in range(len(m)):
                ...
                browser = webdriver.Chrome(chrome_options=option)
                browser.get(url_2)
                sql = "insert into t_jkypspm(c_bh, dt_insertTime, c_url, b_content,c_json, c_page) VALUES (REPLACE(UUID(),\"-\",\"\"), sysdate(), %s,%s,%s,%s)"
